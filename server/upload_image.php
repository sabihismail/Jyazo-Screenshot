<?php
	define ("HOST", ""); // The database host name
	define ("USERNAME", ""); // The database username
	define ("PASSWORD", ""); // The database password
	define ("DATABASE", "db"); // The database ID
	define ("TABLE_NAME", "screenshot"); // The table name which will contain information about the stored images.
	
	define ("URL_PATH", "ss/"); // The folder where all images will be saved in. This is a relative folder.

	// The password required to be able to upload the script.
	// It is recommended to have a password to prevent unauthorized image uploading.
	define ("UPLOAD_PASSWORD", ""); 
	define ("SALT", ""); // The salt that the generated URL will embed when creating a sha1 hash.
